...
export const translations = {
  ru: {
    ...
    python_module_2: "Модуль 2 AI according to the example",
    python_module_3: "Модуль 3 AI according to the example",
    python_module_4: "Модуль 4 AI according to the example",
    python_module_5: "Модуль 5 AI according to the example",
  ...
  en: {
    ...
    python_module_1: "Module 1 AI according to the example",
    python_module_2: "Module 2 AI according to the example",
    python_module_3: "Module 3 AI according to the example",
    python_module_4: "Module 4 AI according to the example",
    python_module_5: "Module 5 AI according to the example",
